...
# use two signals (for top and bottom rows) to maintain pin#
#====================================================================================================
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports {prx1}]
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports {ptx1}]
...
set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports {prx2}]
set_property -dict {PACKAGE_PIN E6 IOSTANDARD LVCMOS33} [get_ports {ptx2}]
...
# use two signals (for top and bottom rows) to maintain pin#
#====================================================================================================
set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports {prx3}]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports {ptx3}]
